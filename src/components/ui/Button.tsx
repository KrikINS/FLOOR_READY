...
const Button: React.FC<ButtonProps> = ({
    ...
    const variants = {
        primary: 'border-transparent text-white bg-primary hover:bg-blue-700 focus:ring-primary shadow-sm',
        secondary: 'border-slate-300 text-slate-700 bg-white hover:bg-slate-50 focus:ring-primary shadow-sm',
    ...
    return (
        <button
            className={`${baseStyles} ${sizes[size]} ${variants[variant]} ${className} ${isLoading || disabled ? 'opacity-50 cursor-not-allowed' : ''}`}
